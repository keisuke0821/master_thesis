...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\columnwidth]{5_alignment/figs/hist_rotation_angle.png}
  \caption{回転角データのガウシアンフィット。}
  \label{gaussian_fit}
\end{figure}
ガウシアンの中心$\mu=\SI{6.05}{^{\circ}}$と分散$\sigma^{2}=0.21$を得た。これより、最終的な回転角を$\SI{6.05}{^{\circ}}$と決定した。
