...
\begin{figure}[h]
  \begin{tabular}{cc}
    ...
    \begin{minipage}[t]{0.45\hsize}
      \centering
      \includegraphics[keepaspectratio, scale=0.01]{4_elDAQ/figs/new_connector_set.jpg}
      \subcaption{配線の変更}
    \end{minipage}
    %---- 2番目の図 --------------------------
    \begin{minipage}[t]{0.45\hsize}
      \centering
      \includegraphics[keepaspectratio, scale=0.025]{4_elDAQ/figs/new_connector_boot.jpg}
      \subcaption{PYNQの再起動}
    \end{minipage}
    %---- 図はここまで ----------------------
  \end{tabular}
