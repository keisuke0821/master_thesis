...
\begin{figure}[h]
  \begin{tabular}{cc}
    ...
    \begin{minipage}[t]{0.48\hsize}
      \centering
      \includegraphics[keepaspectratio, scale=0.4]{5_alignment/figs/9011_11139_08_11.png}
      \subcaption{\SI{220}{GHz}アレイのビーム中心マップ。}
    ...
    \begin{minipage}[t]{0.48\hsize}
      \centering
      \includegraphics[keepaspectratio, scale=0.32]{5_alignment/figs/9011_11139_04_19.png}
      \subcaption{各検出器のビーム中心の視線。}
  ...
  \begin{tabular}{cc}
    ...
    \begin{minipage}[t]{0.48\hsize}
      \centering
      \includegraphics[keepaspectratio, scale=0.4]{5_alignment/figs/9011_11139_10_04.png}
      \subcaption{\SI{220}{GHz}アレイのビーム中心マップ。}
    ...
    \begin{minipage}[t]{0.48\hsize}
      \centering
      \includegraphics[keepaspectratio, scale=0.32]{5_alignment/figs/9011_11139_12_17.png}
      \subcaption{各検出器のビーム中心の視線。}
